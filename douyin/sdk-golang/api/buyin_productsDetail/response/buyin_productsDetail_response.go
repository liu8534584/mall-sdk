package buyin_productsDetail_response

import (
	"doudian.com/open/sdk_golang/core"
)

type BuyinProductsDetailResponse struct {
	doudian_sdk.BaseDoudianOpApiResponse
	Data *BuyinProductsDetailData `json:"data"`
}
type ActivityInfo struct {
	// 商品参与活动类型。0:未参加活动；1: 超值购
...
type Tags struct {
	// 是否有【抖in好物】标签
	HasDouinGoodsTag bool `json:"has_douin_goods_tag"`
	// 是否有品牌旗舰店标签（[品牌]黑标）
...
type BuyinProductsDetailData struct {
	// 商品信息
