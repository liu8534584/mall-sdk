package alliance_materialsProductsDetails_response

import (
	"doudian.com/open/sdk_golang/core"
)

type AllianceMaterialsProductsDetailsResponse struct {
	doudian_sdk.BaseDoudianOpApiResponse
	Data *AllianceMaterialsProductsDetailsData `json:"data"`
}
...
type AllianceMaterialsProductsDetailsData struct {
	// 商品总数
