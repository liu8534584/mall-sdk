...
func (s *TaobaoTbkDgVegasTljTemporaryCreateRequest) SetSecurityLevel(v int32) *TaobaoTbkDgVegasTljTemporaryCreateRequest {
	s.SecurityLevel = &v
	return s
}
...
func (s *TaobaoTbkDgVegasTljTemporaryCreateRequest) SetUseEndTimeMode(v int32) *TaobaoTbkDgVegasTljTemporaryCreateRequest {
	s.UseEndTimeMode = &v
	return s
}
...
func (s *TaobaoTbkDgVegasTljTemporaryCreateRequest) SetUserTotalWinNumLimit(v int32) *TaobaoTbkDgVegasTljTemporaryCreateRequest {
