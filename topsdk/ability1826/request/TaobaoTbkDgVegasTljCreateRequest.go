...
type TaobaoTbkDgVegasTljCreateRequest struct {
	...
	/*
	   必须传入0     */
	SecurityLevel *int32 `json:"security_level,omitempty" required:"false" `
	/*
	...
	UseEndTimeMode *int32 `json:"use_end_time_mode,omitempty" required:"false" `
	/*
	...
	/*
	   单用户累计中奖次数上限     */
	UserTotalWinNumLimit *int32 `json:"user_total_win_num_limit" required:"true" `
	/*
	   淘礼金名称，最大10个字符     */
...
func (s *TaobaoTbkDgVegasTljCreateRequest) SetSecurityLevel(v int32) *TaobaoTbkDgVegasTljCreateRequest {
	s.SecurityLevel = &v
	return s
}
...
func (s *TaobaoTbkDgVegasTljCreateRequest) SetUseEndTimeMode(v int32) *TaobaoTbkDgVegasTljCreateRequest {
	s.UseEndTimeMode = &v
	return s
}
...
func (s *TaobaoTbkDgVegasTljCreateRequest) SetUserTotalWinNumLimit(v int32) *TaobaoTbkDgVegasTljCreateRequest {
...
func (s *TaobaoTbkDgVegasTljCreateRequest) SetItemId(v string) *TaobaoTbkDgVegasTljCreateRequest {
	s.ItemId = &v
	return s
}
