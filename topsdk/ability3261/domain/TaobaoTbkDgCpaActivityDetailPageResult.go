...
type TaobaoTbkDgCpaActivityDetailPageResult struct {
	...
	/*
	   数据批次号(时间戳)     */
	Runtime *util.LocalTime `json:"runtime,omitempty" `
}
...
func (s *TaobaoTbkDgCpaActivityDetailPageResult) SetRuntime(v util.LocalTime) *TaobaoTbkDgCpaActivityDetailPageResult {
	s.Runtime = &v
	return s
}
