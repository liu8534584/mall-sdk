...
func (s *TaobaoTbkDgCpaActivityDetailRequest) SetQueryType(v int32) *TaobaoTbkDgCpaActivityDetailRequest {
	s.QueryType = &v
	return s
}
func (s *TaobaoTbkDgCpaActivityDetailRequest) SetPageSize(v int32) *TaobaoTbkDgCpaActivityDetailRequest {
	s.PageSize = &v
	return s
}
func (s *TaobaoTbkDgCpaActivityDetailRequest) SetPageNo(v int32) *TaobaoTbkDgCpaActivityDetailRequest {
	s.PageNo = &v
	return s
}
