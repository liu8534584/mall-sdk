...
type TaobaoTbkDgMaterialOptionalMapData struct {
	...
	/*
	   搜索类型     */
	ItemSearchType *string `json:"item_search_type,omitempty" `
}
...
func (s *TaobaoTbkDgMaterialOptionalMapData) SetNumIid(v string) *TaobaoTbkDgMaterialOptionalMapData {
	s.NumIid = &v
	return s
}
...
func (s *TaobaoTbkDgMaterialOptionalMapData) SetItemId(v string) *TaobaoTbkDgMaterialOptionalMapData {
	s.ItemId = &v
	return s
}
...
func (s *TaobaoTbkDgMaterialOptionalMapData) SetLocalizationExtend(v string) *TaobaoTbkDgMaterialOptionalMapData {
...
func (s *TaobaoTbkDgMaterialOptionalMapData) SetRankPageUrl(v string) *TaobaoTbkDgMaterialOptionalMapData {
	s.RankPageUrl = &v
	return s
}
func (s *TaobaoTbkDgMaterialOptionalMapData) SetItemSearchType(v string) *TaobaoTbkDgMaterialOptionalMapData {
	s.ItemSearchType = &v
	return s
}
