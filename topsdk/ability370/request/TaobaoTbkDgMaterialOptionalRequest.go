...
func (s *TaobaoTbkDgMaterialOptionalRequest) SetPageSize(v int32) *TaobaoTbkDgMaterialOptionalRequest {
	s.PageSize = &v
	return s
}
func (s *TaobaoTbkDgMaterialOptionalRequest) SetPageNo(v int32) *TaobaoTbkDgMaterialOptionalRequest {
	s.PageNo = &v
	return s
}
...
func (s *TaobaoTbkDgMaterialOptionalRequest) SetBizSceneId(v string) *TaobaoTbkDgMaterialOptionalRequest {
	s.BizSceneId = &v
	return s
}
func (s *TaobaoTbkDgMaterialOptionalRequest) SetPromotionType(v string) *TaobaoTbkDgMaterialOptionalRequest {
	s.PromotionType = &v
	return s
}
