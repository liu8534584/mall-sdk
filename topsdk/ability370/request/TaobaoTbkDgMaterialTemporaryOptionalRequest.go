...
import (
	"github.com/liu8534584/mall-sdk/topsdk/ability370/domain"
...
func (s *TaobaoTbkDgMaterialTemporaryOptionalRequest) SetStartDsr(v int32) *TaobaoTbkDgMaterialTemporaryOptionalRequest {
	s.StartDsr = &v
	return s
}
func (s *TaobaoTbkDgMaterialTemporaryOptionalRequest) SetPageSize(v int32) *TaobaoTbkDgMaterialTemporaryOptionalRequest {
	s.PageSize = &v
	return s
}
func (s *TaobaoTbkDgMaterialTemporaryOptionalRequest) SetPageNo(v int32) *TaobaoTbkDgMaterialTemporaryOptionalRequest {
	s.PageNo = &v
	return s
}
func (s *TaobaoTbkDgMaterialTemporaryOptionalRequest) SetPlatform(v int32) *TaobaoTbkDgMaterialTemporaryOptionalRequest {
	s.Platform = &v
	return s
}
func (s *TaobaoTbkDgMaterialTemporaryOptionalRequest) SetEndTkRate(v int32) *TaobaoTbkDgMaterialTemporaryOptionalRequest {
	s.EndTkRate = &v
	return s
}
func (s *TaobaoTbkDgMaterialTemporaryOptionalRequest) SetStartTkRate(v int32) *TaobaoTbkDgMaterialTemporaryOptionalRequest {
	s.StartTkRate = &v
	return s
}
func (s *TaobaoTbkDgMaterialTemporaryOptionalRequest) SetEndPrice(v int32) *TaobaoTbkDgMaterialTemporaryOptionalRequest {
	s.EndPrice = &v
	return s
}
func (s *TaobaoTbkDgMaterialTemporaryOptionalRequest) SetStartPrice(v int32) *TaobaoTbkDgMaterialTemporaryOptionalRequest {
	s.StartPrice = &v
	return s
}
...
func (s *TaobaoTbkDgMaterialTemporaryOptionalRequest) SetNpxLevel(v int32) *TaobaoTbkDgMaterialTemporaryOptionalRequest {
	s.NpxLevel = &v
	return s
}
...
func (s *TaobaoTbkDgMaterialTemporaryOptionalRequest) SetEndKaTkRate(v int32) *TaobaoTbkDgMaterialTemporaryOptionalRequest {
	s.EndKaTkRate = &v
	return s
}
func (s *TaobaoTbkDgMaterialTemporaryOptionalRequest) SetStartKaTkRate(v int32) *TaobaoTbkDgMaterialTemporaryOptionalRequest {
	s.StartKaTkRate = &v
	return s
}
...
func (s *TaobaoTbkDgMaterialTemporaryOptionalRequest) SetGetTopnRate(v int32) *TaobaoTbkDgMaterialTemporaryOptionalRequest {
	s.GetTopnRate = &v
	return s
}
