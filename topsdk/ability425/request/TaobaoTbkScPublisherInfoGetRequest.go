...
type TaobaoTbkScPublisherInfoGetRequest struct {
    ...
    /*
        类型，必选 1:渠道信息；2:会员信息     */
    InfoType  *int32 `json:"info_type" required:"true" `
    /*
    ...
    ExternalType  *int32 `json:"external_type,omitempty" required:"false" `
}
...
func (s *TaobaoTbkScPublisherInfoGetRequest) SetPageNo(v int32) *TaobaoTbkScPublisherInfoGetRequest {
    s.PageNo = &v
    return s
}
func (s *TaobaoTbkScPublisherInfoGetRequest) SetPageSize(v int32) *TaobaoTbkScPublisherInfoGetRequest {
    s.PageSize = &v
    return s
}
func (s *TaobaoTbkScPublisherInfoGetRequest) SetInfoType(v int32) *TaobaoTbkScPublisherInfoGetRequest {
    s.InfoType = &v
    return s
}
...
func (s *TaobaoTbkScPublisherInfoGetRequest) SetExternalType(v int32) *TaobaoTbkScPublisherInfoGetRequest {
    s.ExternalType = &v
    return s
}
