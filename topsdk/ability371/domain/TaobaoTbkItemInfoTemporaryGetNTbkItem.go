...
type TaobaoTbkItemInfoTemporaryGetNTbkItem struct {
    ...
    /*
        店铺dsr 评分     */
    ShopDsr  *int32 `json:"shop_dsr,omitempty" `

    /*
        卖家等级     */
    Ratesum  *int32 `json:"ratesum,omitempty" `
...
func (s *TaobaoTbkItemInfoTemporaryGetNTbkItem) SetUserType(v int32) *TaobaoTbkItemInfoTemporaryGetNTbkItem {
    s.UserType = &v
    return s
}
...
func (s *TaobaoTbkItemInfoTemporaryGetNTbkItem) SetVolume(v int32) *TaobaoTbkItemInfoTemporaryGetNTbkItem {
    s.Volume = &v
    return s
}
...
func (s *TaobaoTbkItemInfoTemporaryGetNTbkItem) SetShopDsr(v int32) *TaobaoTbkItemInfoTemporaryGetNTbkItem {
    s.ShopDsr = &v
    return s
}
func (s *TaobaoTbkItemInfoTemporaryGetNTbkItem) SetRatesum(v int32) *TaobaoTbkItemInfoTemporaryGetNTbkItem {
    s.Ratesum = &v
    return s
}
