...
func (s *TaobaoTbkItemInfoGetNTbkItem) SetUserType(v int32) *TaobaoTbkItemInfoGetNTbkItem {
    s.UserType = &v
    return s
}
...
func (s *TaobaoTbkItemInfoGetNTbkItem) SetVolume(v int32) *TaobaoTbkItemInfoGetNTbkItem {
    s.Volume = &v
    return s
}
...
func (s *TaobaoTbkItemInfoGetNTbkItem) SetShopDsr(v int32) *TaobaoTbkItemInfoGetNTbkItem {
    s.ShopDsr = &v
    return s
}
func (s *TaobaoTbkItemInfoGetNTbkItem) SetRatesum(v int32) *TaobaoTbkItemInfoGetNTbkItem {
    s.Ratesum = &v
    return s
}
