...
type TaobaoTbkCouponGetMapData struct {
    ...
    CouponSrcScene  *int32 `json:"coupon_src_scene,omitempty" `
...
func (s *TaobaoTbkCouponGetMapData) SetCouponSrcScene(v int32) *TaobaoTbkCouponGetMapData {
    s.CouponSrcScene = &v
    return s
}
func (s *TaobaoTbkCouponGetMapData) SetCouponType(v int32) *TaobaoTbkCouponGetMapData {
    s.CouponType = &v
    return s
}
