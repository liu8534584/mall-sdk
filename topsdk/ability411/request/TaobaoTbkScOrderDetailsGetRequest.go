...
func (s *TaobaoTbkScOrderDetailsGetRequest) SetQueryType(v int32) *TaobaoTbkScOrderDetailsGetRequest {
    s.QueryType = &v
    return s
}
...
func (s *TaobaoTbkScOrderDetailsGetRequest) SetPageSize(v int32) *TaobaoTbkScOrderDetailsGetRequest {
    s.PageSize = &v
    return s
}
func (s *TaobaoTbkScOrderDetailsGetRequest) SetMemberType(v int32) *TaobaoTbkScOrderDetailsGetRequest {
    s.MemberType = &v
    return s
}
func (s *TaobaoTbkScOrderDetailsGetRequest) SetTkStatus(v int32) *TaobaoTbkScOrderDetailsGetRequest {
    s.TkStatus = &v
    return s
}
...
func (s *TaobaoTbkScOrderDetailsGetRequest) SetJumpType(v int32) *TaobaoTbkScOrderDetailsGetRequest {
    s.JumpType = &v
    return s
}
func (s *TaobaoTbkScOrderDetailsGetRequest) SetPageNo(v int32) *TaobaoTbkScOrderDetailsGetRequest {
    s.PageNo = &v
    return s
}
func (s *TaobaoTbkScOrderDetailsGetRequest) SetOrderScene(v int32) *TaobaoTbkScOrderDetailsGetRequest {
    s.OrderScene = &v
    return s
}
