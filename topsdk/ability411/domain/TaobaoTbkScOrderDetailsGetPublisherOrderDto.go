...
type TaobaoTbkScOrderDetailsGetPublisherOrderDto struct {
	...
	SubsidyInfoDtoList *[]TaobaoTbkScOrderDetailsGetSubsidyDetailDTO `json:"subsidy_info_dto_list,omitempty" `
	...
	AlimmShareInfoDto *TaobaoTbkScOrderDetailsGetAlimmShareInfoDTO `json:"alimm_share_info_dto,omitempty" `

	/*
	   平台专项服务费比率。解释：指该笔订单推广者在各种特殊场景下需支付给淘宝联盟的所有专项服务费比率总和。平台专项服务费比率=专项服务费比率a+专项服务费比率b+…     */
	PlatformSpecialServiceRate *float64 `json:"platform_special_service_rate,omitempty" `
	...
	PlatformSpecialServiceFee *float64 `json:"platform_special_service_fee,omitempty" `

	/*
	   平台专项服务费明细节点。解释：各项平台专项服务费类型的类型名称、扣费比率、扣费金额的详细说明     */
	PlatformSpecialShareInfoDto *TaobaoTbkScOrderDetailsGetPlatformSpecialShareInfoDTO `json:"platform_special_share_info_dto,omitempty" `
}
...
func (s *TaobaoTbkScOrderDetailsGetPublisherOrderDto) SetTpOrderId(v string) *TaobaoTbkScOrderDetailsGetPublisherOrderDto {
	s.TpOrderId = &v
	return s
}
...
func (s *TaobaoTbkScOrderDetailsGetPublisherOrderDto) SetPubSharePreFeeForCommission(v float64) *TaobaoTbkScOrderDetailsGetPublisherOrderDto {
	s.PubSharePreFeeForCommission = &v
	return s
}
func (s *TaobaoTbkScOrderDetailsGetPublisherOrderDto) SetPubShareFeeForCommission(v float64) *TaobaoTbkScOrderDetailsGetPublisherOrderDto {
	s.PubShareFeeForCommission = &v
	return s
}
func (s *TaobaoTbkScOrderDetailsGetPublisherOrderDto) SetSubsidyInfoDtoList(v []TaobaoTbkScOrderDetailsGetSubsidyDetailDTO) *TaobaoTbkScOrderDetailsGetPublisherOrderDto {
	s.SubsidyInfoDtoList = &v
	return s
}
func (s *TaobaoTbkScOrderDetailsGetPublisherOrderDto) SetPubShareRateForSdy(v float64) *TaobaoTbkScOrderDetailsGetPublisherOrderDto {
	s.PubShareRateForSdy = &v
	return s
}
func (s *TaobaoTbkScOrderDetailsGetPublisherOrderDto) SetTkTotalRateForSdy(v float64) *TaobaoTbkScOrderDetailsGetPublisherOrderDto {
	s.TkTotalRateForSdy = &v
	return s
}
func (s *TaobaoTbkScOrderDetailsGetPublisherOrderDto) SetPubSharePreFeeForSdy(v float64) *TaobaoTbkScOrderDetailsGetPublisherOrderDto {
	s.PubSharePreFeeForSdy = &v
	return s
}
func (s *TaobaoTbkScOrderDetailsGetPublisherOrderDto) SetPubShareFeeForSdy(v float64) *TaobaoTbkScOrderDetailsGetPublisherOrderDto {
	s.PubShareFeeForSdy = &v
	return s
}
func (s *TaobaoTbkScOrderDetailsGetPublisherOrderDto) SetAlimmShareInfoDto(v TaobaoTbkScOrderDetailsGetAlimmShareInfoDTO) *TaobaoTbkScOrderDetailsGetPublisherOrderDto {
	s.AlimmShareInfoDto = &v
	return s
}
func (s *TaobaoTbkScOrderDetailsGetPublisherOrderDto) SetPlatformSpecialServiceRate(v float64) *TaobaoTbkScOrderDetailsGetPublisherOrderDto {
	s.PlatformSpecialServiceRate = &v
	return s
}
func (s *TaobaoTbkScOrderDetailsGetPublisherOrderDto) SetPlatformSpecialServiceFee(v float64) *TaobaoTbkScOrderDetailsGetPublisherOrderDto {
	s.PlatformSpecialServiceFee = &v
	return s
}
func (s *TaobaoTbkScOrderDetailsGetPublisherOrderDto) SetPlatformSpecialShareInfoDto(v TaobaoTbkScOrderDetailsGetPlatformSpecialShareInfoDTO) *TaobaoTbkScOrderDetailsGetPublisherOrderDto {
